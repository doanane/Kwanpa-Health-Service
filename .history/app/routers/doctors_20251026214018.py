...
from app.auth.hashing import verify_password, get_password_hash  # Fixed import
    ...
    for profile in patients_profiles:
        ...
        if user:
            ...
            patients_list.append({
                ...
                "last_update": latest_health.date if latest_health else None
            })
